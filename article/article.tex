...
\begin{itemize}
    ...
    \item The main advantage of this approach over traditional coverage analysis approaches is that it very easily scales to a large number of traffic scenarios.
