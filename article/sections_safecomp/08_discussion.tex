...
A data generation script implements some behavior control mechanisms to create 
...
The archetypes used here are defined manually and described in table \ref{tab:subgraph_archetypes}. The chosen archetypes are typical traffic situations like e.g. lead vehicle situations, lane change situations or different combinations of opposite direction vehicles.
