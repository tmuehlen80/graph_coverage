...
Figure \ref{fig:carla_speed_path_distributions} and Figure \ref{fig:argo_speed_path_distributions} show the parameter distribution for the speed and path length of the traffic scenes for CARLA and Argoverse.
