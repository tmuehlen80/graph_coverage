...
This chapter systematically identifies coverage gaps—scenarios present in the Argoverse dataset but absent or underrepresented in the CARLA simulation dataset, to demonstrate that graph embeddings can capture these structural and parametric differences in larger, more complex graphs.
