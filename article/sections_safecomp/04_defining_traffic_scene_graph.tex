...
The map graph is constructed by processing map data from Argoverse or CARLA (see Section \ref{chapter:datasets}) to extract these relationships. Lanes with geometric overlap are marked as intersection lanes.
