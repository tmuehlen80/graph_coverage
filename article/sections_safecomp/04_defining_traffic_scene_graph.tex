...
An obvious extension is to create graphs for multiple timesteps, e.g. to analyze the evolution of 
the traffic scene over time for the sake of coverage analysis. This will be part of future work streams of this project. 
