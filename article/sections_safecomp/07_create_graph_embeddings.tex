...
A Graph Isomorphism Network with Edge features (GINE) \cite{hu2020strategiespretraininggraphneural} is used to generate embeddings, implemented in PyTorch Geometric (\cite{Fey/Lenssen/2019}). GINE is chosen because it directly incorporates edge features through its aggregation function: edge type and path length between actors are encoded as edge features (see Section \ref{fig:graph_gine_architecture}) and directly influence the message-passing process.
