...
This paper is concerned with completeness of the observed scenes, not with the safety of the system. The two are connected---a reasonable strategy is to focus coverage analysis on the more safety-critical scenes---but here the focus is solely on coverage, and we leave safety considerations to future work.
