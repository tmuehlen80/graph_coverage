...
This is a completeness argument, not a safety analysis, though any safety analysis can in turn only be carried out on top of such a completeness argument.
...
As this paper is focussing on coverage analysis, it is not concerned with the safety of the system, but rather with the completeness of the observed scenes. There are of course many connections between coverage and safety aspects, e.g. a reasonable strategy is to put higher focus in coverage analysis on the scenes that are more safety-critical, however, in this paper the focus is solely on coverage and we leave it to future work to expand this work to include safety considerations.
