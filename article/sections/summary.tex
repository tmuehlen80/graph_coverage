...
The subgraph isomorphism approach utilizes a set of manually defined archetype graphs representing common driving scenarios.
...
This representation enables similarity-based coverage assessment, clustering of related scenarios, and anomaly detection for identifying underrepresented traffic situations with arbitrary number of actors.
